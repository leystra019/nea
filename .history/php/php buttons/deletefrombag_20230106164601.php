<?php
    ...
    if (mysqli_connect_error()) {
        ...
        if ($delete_result) {
            ...
            $update_quantity_query = "UPDATE product_stock SET stock_level = stock_level - stock_level WHERE product_id = $productid";
            $update_quantity_result = mysqli_query($conn, $delete_quantity_query);
