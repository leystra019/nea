                            ...
                            <form action = "/neatest/php/testing.php" method="post">
                                ...
                                <tr>
                                    <?php
                                        ...
                                        function delete($DATABASE_HOST, $DATABASE_USER, $DATABASE_PASS, $DATABASE_NAME, $con, $id){
                                            ...
                                            while($row = mysqli_fetch_array($result)) {
                                                echo "<tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class='button'  onclick="delete($DATABASE_HOST, $DATABASE_USER, $DATABASE_PASS, $DATABASE_NAME, $con)">delete</a>
                                                    </td>
                                                </tr>";
                                            }
                                        }
