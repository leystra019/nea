...
function searchorderFunction() {
    ...
    var message = document.getElementById("no-records-message");
  if (!found) {
    message.style.display = "";
    var tbody = document.getElementsByTagName("tbody")[0];
    var newRow = tbody.insertRow(-1); // Insert new row at the end
    var newCell = newRow.insertCell(0);
    newCell.colSpan = rows[0].getElementsByTagName("td").length;
    newCell.innerHTML = "No records have been found.";
  } else {
