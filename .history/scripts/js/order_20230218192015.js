...
document.querySelector('#orders_table').addEventListener('click', function(event) {
    ...
    if (event.target.matches('#edit_order_button')) {
        ...
        var productPrice = row.querySelector('.product_price').textContent;

        document.querySelector('#order_id_input').value = orderId;
        document.querySelector('#product_name_input').value = productName;
        document.querySelector('#product_price_input').value = productPrice;
