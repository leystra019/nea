                            ...
                            <div class="product-modal">
                                <div class="modal-content">
                                    ...
                                    <form action="/neatest/scripts/php/staff/buttons/editorder.php" method="post">
                                        <input type="text" placeholder="order_id(s)" name="order_id" readonly class="order-input-fields">
                                        <input type="text" placeholder="email" name="username" readonly class="order-input-fields">
                                        <input type="text" placeholder="product_id" name="product_id" class="order-input-fields">
                                        <input type="text" placeholder="quantity" name="quantity" class="order-input-fields">
                                        <input type="text" placeholder="price" name="price" class="order-input-fields">
                                        <input type="text" placeholder="status" name="status" class="order-input-fields">
