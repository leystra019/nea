                                ...
                                <?php
                                    ...
                                    if ($result) {
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            echo "<td> <a class='button' id='edit_order_button' data-order-id='" . $row['order_id'] . "' data-product-id='" . $row['product_id'] . "' data-quantity='" . $row['quantity'] . "' data-price='" . $row['price'] . "' data-status='" . $row['status'] . "'>Edit</a> <a class='button' input type='button'  id='change_order_status'>Change status</a>  <a class='button'  id='delete_order_button'>Delete</a></td>";
                                            echo "</tr>";
                                        }
                                    }
                                ?>
