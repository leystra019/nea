...
<head>
    ...
    <link rel="stylesheet" href="/neatest/scripts/css/shop.css">
    ...
    <div class="container">
        ...
        <div class="bg">
            <div class="loginlink">
                ...
                <a href="/neatest/scripts/php/login/ulogin.php"  class="blue-link">login</a>
            </div>
            <div class="ordslink">
                <a href="/neatest/scripts/php/login/slogin.php"class="blue-link">orders</a>
            </div>
            <div class="baglink">
