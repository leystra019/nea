...
<body>
    <div class="container">
        <nav class="sidebar" id="sidebar">
            ...
            <a href="/neatest/scripts/php/staff/manageorder.php"><i class="fa-solid fa-receipt" style="margin-top: 32px; margin-left: 16px; font-size: 31px; color: #FFFFFF;"></i></a>
            <a href="/neatest/scripts/php/staff/manageinventory.php"><i class="fa-solid fa-box-dollar" style="margin-top: 32px; margin-left: 16px; font-size: 31px; color: #FFFFFF;"></i></a>
        </nav>
        <main>
            <div class="bg">
                <div class="loginlink">
