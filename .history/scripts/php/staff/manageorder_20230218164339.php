        ...
        <div class="bg">
            <main>
                <div class="card">
                    ...
                    <div class="table" >
                        <table style= "border-collapse: collapse" align="center" border= "1" width="80%">
                                ...
                                <?php
                                    ...
                                    if ($result) {
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            echo "<td> <a class='button' id='edit_order_button' data-order-id='" . $row['order_id'] . "' data-product-id='" . $row['product_id'] . "' data-quantity='" . $row['quantity'] . "' data-price='" . $row['price'] . "' data-status='" . $row['status'] . "'>Edit</a> <button class='button'  id='change_order_status'>Change status</button>  <a class='button'  id='delete_order_button'>Delete</a></td>";
                                            echo "</tr>";
                                        }
                                    }
                                ?>
