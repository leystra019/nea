...
<body>
    <div class="container">
        <nav class="sidebar" id="sidebar">
            ...
            <a href="/neatest/scripts/php/staff/manageorder.php"><i class="fa-solid fa-receipt" style="margin-top: 32px; margin-left: 20px; font-size: 31px; color: #FFFFFF;"></i></a>
            ...
            <main>
                <div class="card">
                    <div style="z-index: 1;" class="taskbarcontainer">
                        ...
                        <input type="text" id ="tasksrch" onkeyup="searchproductsFunction()" placeholder="Search for task(s)...">
                    </div>
