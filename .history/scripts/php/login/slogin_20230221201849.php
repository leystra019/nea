    ...
    if (isset($_POST['login'])) {
         ...
         if($conn->connect_error){
            ...
            if ($hashed_password === null) {
                ...
                echo '<div class="alert alert-warning">Sorry this staff member does not exist</div>';
            }

            

                // Verify that the user-provided password matches the stored hash
            else if (password_verify($password, $hashed_password) && $staff_id == $id) {
                ...
                echo '<div class="alert alert-warning">1 or more of your details was incorrect</div>';
            } 
        }
    }
?>
