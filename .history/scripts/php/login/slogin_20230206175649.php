<?php
    ...
    if (isset($_POST['login'])) {
        ...
        if (password_verify($password, $hashed_password)) {
            ...
            // get the value of the staff's id and name, set variables to both
            $staff_id = $row['id'];
            $staff_name = $row['name'];
            //create a cookie variable to say to the website this is the staff's name
            $staff_name_cookie = 'name';
            //set the cookie using the variables, and set a time (in seconds)
            setcookie($staff_name_cookie, $staff_name, time() + 86400);

            //create a cookie variable to say to the website this is the staff's id
            $staff_id_cookie = 'staff_id';
            //set the cookie using the variables, and set a time (in seconds)
            setcookie($staff_id_cookie, $staff_id, time() + 86400);
    ...
    <div class="background">
        <div class="ln-card">
            ...
            <form method="post">
                ...
                <input type="password" name="password" class="logbox" id="staffid" required title="This field is required">
