    ...
    <div class="background">
        <div class="ln-card">
            ...
            <form method="post">
                ...
                <script>
                    document.getElementById("username").setCustomValidity("Please enter your email address");
                </script>

                <header>Unique ID</header>
                <input type="password" name="staffid" class="logbox" id="staffid" required title="You won field is required">
