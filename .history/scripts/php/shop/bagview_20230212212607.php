        ...
        if (isset($_COOKIE['bag'])) {
            ...
            foreach ($current_bag_keys as $product_id) {
                ...
                if ($current_bag[$product_id] > $row['stock_level']) {
                    ...
                    echo '<script>document.getElementsByClassName("checkout-btn").disabled = true;</script>';
                }
              }
            } else {
            ...
            <div class="bag-card">
                <div id="scroller">
                    <table class="table-bordered">
                        ...
                        <tbody>
                            <?php
                                if (isset($_COOKIE['bag']) && is_string($_COOKIE['bag']) && !empty($_COOKIE['bag'])) {
                                    $current_bag = json_decode($_COOKIE['bag'], true);
                                    if (is_array($current_bag)) {
                                        $current_bag_keys = array_keys($current_bag);
                    ...
                    <?php
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            echo "No products found in the shopping bag.";
                        }
                    ?>
                ...
                <div class="final_container">
                    <div class="checkout-btn" visibility="hidden">
