        ...
        if (isset($_COOKIE['bag'])) {
            ...
            foreach ($current_bag_keys as $product_id) {
                ...
                if ($current_bag[$product_id] > $row['stock_level']) {
                    ...
                    echo '<script>document.getElementsByClassName("checkout-ink")[0].style.display = "none";</script>';
                }
              }
            } else {
              echo '<div class="alert alert-warning">Your bag is empty. Please add some items in order to proceed to checkout.</div>';
              echo '<script>document.getElementsByClassName("checkout-link")[0].style.display = "none";</script>';
            }
        }
            ...
            <div class="bag-card">
                ...
                <div class="final_container">
                    <div class="checkout-btn">
                        <a href="/neatest/scripts/php/shop/checkout.php" class="checkout-link">Checkout</a>
                    </div>
