            ...
            <div class="divide">
                ...
                <div class="pdescription">
                    ...
                    ?>
                        ...
                        <input type="submit" value="<?php if ($product_out_of_stock == true) { echo 'Out of Stock'; } else { echo 'Add to Bag'; } ?>"  id="bagbtn" class="bagbtn <?php if ($product_out_of_stock == true) { echo 'bagbtn-out-of-stock'; } ?>" name="bagbtn" <?php if ($product_out_of_stock == true) { echo 'disabled'; } ?>>
