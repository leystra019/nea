...
if (isset($_SESSION['name'])) {
    ...
    echo "Hello I think this does not work yes";
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <nav class="sidebar" id="sidebar">
            <i class="fa-sharp fa-solid fa-bars" id="btn" style="font-size: 31px; color: #FFFFFF;"></i>
                <ul class="sidebar-list" id="sidebar-list">
                    ...
                    <li>
                        <a href="/neatest/scripts/php/shop/allproducts.php" class="item-link">Dildo's</a>
                    </li>
                    <li>
                        <a href="/neatest/scripts/php/shop/allproducts.php" class="item-link">Pocket Pussy's</a>
                    </li>
                    <li>
                        <a href="/neatest/scripts/php/shop/allproducts.php" class="item-link">Lube</a>
                    </li>
                    <li>
                        <a href="/neatest/scripts/php/shop/allproducts.php" class="item-link">Sex dolls</a>
                    </li>
                    <li>
        ...
        <div class="bg">
            ...
            <?php
                if (isset($_SESSION['session_auth'])) {
                    $user_type = $_COOKIE['session_auth'];
                    echo $user_type;
                } else {
                    echo 'cookie not been set';
                }
                if (isset($_SESSION['session_auth']) && ($_SESSION['session_auth'] == 1 || $_SESSION['session_auth'] == 2)) {
