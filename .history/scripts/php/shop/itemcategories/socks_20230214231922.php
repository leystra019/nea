...
<body>
    ...
    <nav class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-list" id="sidebar-list">
                ...
                <li>
                    <a href="/neatest/scripts/php/shop/itemcategories/bottomwear.php" class="item-link">Bottomwear</a>
                </li>
                <li>
                    <a href=" " class="item-link">Socks</a>
                </li>
                <li>
        ...
        <div class="bg">
            ...
            <?php
                ...
                if ($conn->connect_error) {
                    ...
                    $query = "SELECT * FROM product_stock WHERE category = 'socks'";
