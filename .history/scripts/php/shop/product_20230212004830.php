            ...
            <div class="divide">
                ...
                <div class="pdescription">
                    ...
                    <form method="post">
                        ...
                        <input type="submit" value="<?php if ($product_out_of_stock = true) { echo 'Out of Stock'; } else { echo 'Add to Bag'; } ?>"  id="bagbtn" class="bagbtn" name="bagbtn" <?php if ($product_out_of_stock) { echo 'disabled'; } ?>>
