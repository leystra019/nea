            ...
            <div class = "checkedoutcontainer">
                <div class="bag-card-2">
                    ...
                    <?php
                        ...
                        $sql = "SELECT order_number FROM orders WHERE id = 123"; // Replace "123" with the actual ID of the order you want to retrieve
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            // Retrieve the order number from the results
