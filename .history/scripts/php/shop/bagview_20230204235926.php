<?php
    ...
    if (!isset($_COOKIE['cookie_auth'])) {
        ...
        header('location: /neatest/scripts/php/ulogin.php');
    }
        ...
        if(isset($_GET['remove'])){
            ...
            if (isset($current_bag[$remove_item])<= 1) {
            ...
            <div class="bag-card">
                        ...
                        <tbody>
                            <?php
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<td><a class='button' href='/neatest/scripts/php/shop/buttons/updatebag.php'>update</a><a class='button' href='/neatest/html/shop/bagview.php?remove=".$row['product_id']."' onclick='return confirm(\"remove item from bag?\")'>delete</a></td>";
                                    echo "</tr>";
                ...
                <div class="final_container">
                    ...
                    <div class="continueshop-btn">
                        <a href="/neatest/html/shop/allproducts.php">Continue Shop</a>
