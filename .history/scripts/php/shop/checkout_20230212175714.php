<?php
    ...
    if (mysqli_stmt_execute($stmt)) {
      ...
      $stmt = mysqli_prepare($conn, $sql);
      mysqli_stmt_bind_param($stmt, "iidi", $user_id, $order_id, $product_id $total_quantity, $status);
      if (mysqli_stmt_execute($stmt)) {
        ...
        foreach ($product_ids as $product_id) {
          ...
          mysqli_stmt_bind_param($stmt, "iii", $order_id, $product_ids, $product_quantity);
