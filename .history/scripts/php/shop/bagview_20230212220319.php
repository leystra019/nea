...
?>
<script>
    // check if the checkout should be disabled
    var checkout_disabled = <?php echo ($checkout_disabled) ? 'true' : 'false'; ?>;
    if (checkout_disabled) {
        document.querySelector('.checkout-link').setAttribute('disabled', 'disabled');
    }
</script>
