<?php
    ...
    if (!isset($_COOKIE['user_id'])) { ?>
        <div class="alert">
            ...
            <bold>Warning!</bold> You must log-in before adding items to a basket.
        </div>
    <?php } ?>

    <!-- Add the product to the shopping bag if the user is logged in -->
    <?php if (isset($_POST['add_to_bag']) && isset($_COOKIE['user_id'])) {
        // set the cookie
