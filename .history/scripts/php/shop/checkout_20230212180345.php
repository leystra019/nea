<?php
    ...
    if (mysqli_stmt_execute($stmt)) {
      ...
      $sql = "INSERT INTO orders (user_id, order_id, quantity, status) VALUES (?, ?, ?, ?)";
      $stmt = mysqli_prepare($conn, $sql);
      mysqli_stmt_bind_param($stmt, "iiidi", $user_id, $order_id, $product_id, $total_quantity, $status);
      if (mysqli_stmt_execute($stmt)) {
        ...
        foreach ($product_ids as $product_id) {
          ...
          mysqli_stmt_bind_param($stmt, "iii", $order_id, $product_id, $product_quantity);
