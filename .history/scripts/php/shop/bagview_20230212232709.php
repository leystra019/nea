                            ...
                            <?php
                                if (isset($_COOKIE['bag'])) {
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        echo "<td><a class='button' href='/neatest/scripts/php/shop/buttons/updatebag.php?update'>update</a><a class='button' href='/neatest/scripts/php/shop/bagview.php?remove=".$row['product_id']."' onclick='return confirm(\"remove item from bag?\")'>delete</a></td>";
                                        echo "</tr>";
