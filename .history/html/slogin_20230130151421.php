    ...
    if (isset($_POST['login'])) {
        ...
        // Prepare our SQL, preparing the SQL statement will prevent SQL injection.
            ...
            if (password_verify($password, $hashed_password)) {
                ...
                $sql = "SELECT id, name FROM staff WHERE username = ?";
                //prepare the statemnt
                $stmt = mysqli_prepare($conn, $sql);
                //set the username variable too the username posted in the form
                ...
                //create a cookie variable to say to the website this is the user's name
                $user_name_cookie = 'name';
                //set the cookie using the variables, and set a time (in seconds)
                setcookie($user_name_cookie, $user_name, time() + 86400);

                //create a cookie variable to say to the website this is the user's id
...
<body>
    <div class="background">
        <div class="ln-card">
            ...
            <form action="/neatest/php/main php/authslogin.php" method="post">
                ...
                <input type="password" name="password" class="logbox" id="password">
