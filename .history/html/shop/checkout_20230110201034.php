                        ...
                        <form action="/neatest/php/main php/check_out.php" method="post">
                            <?php
                              ...
                              if (isset($_COOKIE['phone'])) {
                                echo '<input type="text" class="short-form" placeholder="Phone Number" required title="This field is required" name="phone" maxlength="14" onblur="validatePhoneNumber(this.value)" value="' . htmlspecialchars($_COOKIE['phone']) . '">';
                              } else {
                                echo '<input type="text" class="short-form" placeholder="Phone Number" required title="This field is required" onblur="validatePhoneNumber(this.value)" maxlength="14" name="phone">';
                              }
                              ...
                              if (isset($_COOKIE['postcode'])) {
                                echo '<input type="text" class="short-form" placeholder="Postcode" name="postcode" max length = "7" required title="This field is required" value="' . htmlspecialchars($_COOKIE['postcode']) . '">';
                              } else {
                                echo '<input type="text" class="short-form" placeholder="postcode" maxlength = "7" required title="This field is required" name="postcode">';
                              }
