          ...
          <div class = "checkoutcontainer">
              ...
              <div class="left-content">
                <form action=" " id="checkout-form" method="post">
                  ...
                  <input type="text" class="short-form" placeholder="Residence" required title="This field is required" name="residence" pattern="[A-Za-z]{3}" value="<?php echo $residence; ?>">
                  ...
                  <input type="text" class="short-form" placeholder="Postcode" required title="This field is required" name="postcode" maxlength="6" value="<?php echo $postcode; ?>">
