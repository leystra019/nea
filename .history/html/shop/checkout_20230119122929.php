            ...
            <div class="bag-card">
                <div class = "checkoutcontainer">
                    ...
                    <div class="left-content">
                      ...
                      <input type="text" class="long-form" placeholder="Billing Adress" required title="This field is required" name="billingad" value="<?php if(isset($) && !empty($residence)){echo $residence;} ?>">
