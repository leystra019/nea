          ...
          <div class = "checkoutcontainer">
              ...
              <div class="left-content">
                <form action=" " id="checkout-form" method="post">
                  ...
                  <input type="name" class="short-form" placeholder="Name" name="name" required title="This field is required">
                  <input type="email" class="short-form" placeholder="Email" required title="This field is required" name="email">
                  <input type="text" class="short-form" placeholder="Phone Number" required title="This field is required" name="phone" maxlength="14">
                  <input type="text" class="short-form" placeholder="Residence" required title="This field is required" name="residence">
                  <input type="text" class="long-form" placeholder="Billing Adress" required title="This field is required" name="billingad">
                  <input type="text" class="long-form" placeholder="Shipping Adress" required title="This field is required" name="shippingad">
                  <input type="text" class="short-form" placeholder="City" required title="This field is required" name="city" maxlength="14">
                  <input type="text" class="short-form" placeholder="Postcode" required title="This field is required" name="postcode">
