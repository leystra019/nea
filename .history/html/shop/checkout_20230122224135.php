              ...
              <div class="left-content">
                <form action=" " id="checkout-form" method="post">
                  ...
                  ?>
                    ...
                    <input type="email" class="short-form" placeholder="Email" required title="This field is required" name="email" value="<?php echo $email; ?>">
                    <input type="text" class="short-form" placeholder="Phone Number" required title="This field is required" name="phone" maxlength="14" value="<?php echo $phone; ?>">
                    ...
                    <input type="text" class="short-form" placeholder="City" required title="This field is required" name="city" maxlength="14" value="<?php echo $city; ?>">
                    <input type="text" class="short-form" placeholder="Postcode" required title="This field is required" name="postcode"  value="<?php echo $postcode; ?>">
