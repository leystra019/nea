<?php
  ...
  if(isset($_POST) && !empty($_POST)){
    ...
    $sql = "UPDATE users SET name='$name', email='$email', phone='$phone', residence='$residence', billingad='$billingad', shippingad='$shippingad', city='$city', postcode='$postcode' WHERE user_id='$user_id'";
