            ...
            <table class="table-bordered">
                ...
                <?php
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td><a class='button' href='/neatest/php/php buttons/deletefrombag.php?remove=<?php echo $row['product_id']; ?>' onclick='return confirm(\"remove item from cart?\")'>delete</a></td>";
                        echo "</tr>";
                    }
                ?>
            </table>
