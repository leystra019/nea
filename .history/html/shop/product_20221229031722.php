...
if(isset($_POST['add_to_bag'])) {
    ...
    if(mysqli_num_rows($select_cart) > 0){
        $message[] = 'product has already been added to bag';
    }else {
        $insert_product = mysqli_query($conn, "INSERT INTO bag (title, price, image, quantity) VALUES ('$product_title', '$product_price', '$product_image', '')");
