<?php
    ...
    if(isset($_POST) && !empty($_POST)){
        ...
        if(isset($_COOKIE['name'])){
            echo 'The name cookie has been set';
        }
    }
            ...
            <div class="bag-card">
                <div class = "checkoutcontainer">
                    ...
                    <div class="left-content">
                      <form action="/neatest/php/main php/check_out.php" id="checkout-form" method="post">
                        <?php
                          if (isset($_COOKIE['name'])) {
                        ...
                        ?>
                            ...
                            <div class="finalch_container">
                                <input type = "submit" class = "checkout-btn" id="checkout">Checkout</input>
                            </div>
                      </form>
