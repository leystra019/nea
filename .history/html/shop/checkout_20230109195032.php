                        ...
                        <form action="/neatest/php/main php/check_out.php" method="post">
                            <?php
                                if(isset($_COOKIE['name'])) {
                                    <input type="text" class="short-form" placeholder="Name" name="name" value="<php echo htmlspecialchars($_COOKIE['name']); ?>">
                                } else {
                                    <input type="text" class="short-form" placeholder="Name" name="name">
                                }
