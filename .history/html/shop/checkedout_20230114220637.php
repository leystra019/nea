        ...
        <div class="bg">
            ...
            <div class = "checkedoutcontainer">
                <div class="bag-card-2">
                    <p1> Dear </p1>
                    <p2> Your order has been succesfully submitted on  at  . Once we have processed your order, you will receive your shipping confirmation </p2>
                    <div class="line"></div>
                    <p3> Your Order </p3>
                    <div class="orderedprods"></div>
                    <div class="tax box">
                        <div class="bag-total">
                            <a>Bag Total</a>
                            <a>Shipping tax</a>
