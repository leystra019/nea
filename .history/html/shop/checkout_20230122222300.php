          ...
          <div class = "checkoutcontainer">
              ...
              <div class="left-content">
                <form action=" " id="checkout-form" method="post">
                  ...
                  <input type="text" class="long-form" placeholder="Shipping Adress" required title="This field is required" name="shippingad" value="<?php if(isset($) && !empty($shippingad)){echo $shippingad;} ?>">
                ...
                <div class="saveinfotxt">
                  ...
                  <?php echo '<label for="saveinfo" onclick = "" class="saveinfotxt">Save info? </label><input type="checkbox" id="saveinfo">'; ?>
                </div>
