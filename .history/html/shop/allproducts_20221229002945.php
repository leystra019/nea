...
<body>
    <div class="container">
        ...
        <div class="bg">
            ...
            <a style="margin-top: 61px !important; margin: left 157px !important;">SneakersnSteals</a>
                ...
                if ($conn->connect_error) {
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($product = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<img src='uploaded_img/$product_image' width='150px' height='150px' margin-right= '62px' alt=''>";
                            echo "</a>";
                        }
                    }
                }
