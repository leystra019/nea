<?php
    ...
    if(isset($_POST['add_to_bag'])) {
        ...
        if(mysqli_num_rows($select_bag) > 0){
            ...
            $insert_product = mysqli_query($conn, "INSERT INTO bag (product_id, title, price, image, quantity) VALUES (NULL, '$productId','$product_title', '$product_price', '$product_image', '$product_quantity')");
