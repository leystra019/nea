          ...
          <div class = "checkoutcontainer">
              ...
              <div class="left-content">
                <form action=" " id="checkout-form" method="post">
                  ...
                  ?>
                  <input type="name" class="short-form" placeholder="Name" name="name" required title="This field is required" value="<?php echo $row; ?>">
                  <input type="email" class="short-form" placeholder="Email" required title="This field is required" name="email" value="">
                  <input type="text" class="short-form" placeholder="Phone Number" required title="This field is required" name="phone" maxlength="11" value="">
                  <input type="text" class="short-form" placeholder="Residence" required title="This field is required" name="residence" value="">
                  <input type="text" class="long-form" placeholder="Billing Adress" required title="This field is required" name="billingad" value="">
                  <input type="text" class="long-form" placeholder="Shipping Adress" required title="This field is required" name="shippingad" value="">
                  <input type="text" class="short-form" placeholder="City" required title="This field is required" name="city" value="">
                  <input type="text" class="short-form" placeholder="Postcode" required title="This field is required" name="postcode" maxlength="6" value="">
