...
<head>
    ...
    <script src="/neatest/hjs/checkout.js" type="text/javascript"></script>
</head>
<body>
<body>
    <div class="container">
                        ...
                        <form action="/neatest/php/main php/check_out.php" method="post">
                            <?php
                              ...
                              if (isset($_COOKIE['phone'])) {
                                echo '<input type="text" class="short-form" placeholder="Phone Number" required title="This field is required" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" maxlength="14" onblur="validatePhoneNumber(this.value)" value="' . htmlspecialchars($_COOKIE['phone']) . '">';
                              } else {
                                echo '<input type="text" class="short-form" placeholder="Phone Number" required title="This field is required" onblur="validatePhoneNumber(this.value)" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" maxlength="14" name="phone">';
                              }
