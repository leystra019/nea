                ...
                <div class = "checkoutcontainer">
                    ...
                    <div class="left-content">
                        <form action="/neatest/php/main php/check_out.php" method="post">
                            ...
                            <input type="text" id="residence" name="residence" class="short-form" placeholder="Enter your residence" required title="This field is required" value="<?php if (isset($_COOKIE['residence'])) { echo htmlspecialchars($_COOKIE['residence']); } ?>">
                            <select id="residence-select" name="residence-select" class="short-form" style="display: none;">
