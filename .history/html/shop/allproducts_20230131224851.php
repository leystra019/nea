    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="bg">
            ...
            <?php
                ...
                $base_url = "http://localhost/neatest/html/shop/images/";
                if ($conn->connect_error) {
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($product = mysqli_fetch_assoc($result)) {
                            ...
                            $product_image = 'images/' . $product_id . '.jpeg';
                    
                            // we need the product_id echoes
                            echo "<a href='product.php?id=$product_id'>";
                            // output the product image in HTML
                            echo "<img src='$base_url$product_image' width='150px' height='150px' margin-right='62px !important' alt=''>";
