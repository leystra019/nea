          ...
          <div class = "checkoutcontainer">
              ...
              <div class="left-content">
                <form action=" " id="checkout-form" method="post">
                  ...
                  ?>
                  <input type="name" class="short-form" placeholder="Name" name="name" required title="This field is required" value="<?php echo $row['name']; ?>">
                  <input type="email" class="short-form" placeholder="Email" required title="This field is required" name="email" value="<?php echo $row['username']; ?>">
                  <input type="text" class="short-form" placeholder="Phone Number" required title="This field is required" name="phone" maxlength="14" value="<?php echo $row['phone']; ?>">
                  <input type="text" class="short-form" placeholder="Residence" required title="This field is required" name="residence" value="<?php echo $row['country']; ?>">
                  <input type="text" class="long-form" placeholder="Billing Adress" required title="This field is required" name="billingad" value="<?php echo $row['address_line_1']; ?>">
                  <input type="text" class="long-form" placeholder="Shipping Adress" required title="This field is required" name="shippingad" value="<?php echo $row['address_line_2']; ?>">
                  <input type="text" class="short-form" placeholder="City" required title="This field is required" name="city" maxlength="14" value="<?php echo $row['city']; ?>">
                  <input type="text" class="short-form" placeholder="Postcode" required title="This field is required" name="postcode" value="<?php echo $row['postcode']; ?>">
