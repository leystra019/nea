...
<div class="container">
    <nav class="sidebar">
        <i class="fa-sharp fa-solid fa-bars" id="btn" div class="barsmenu" style="font-size: 31px; color: #FFFFFF;"></i>
        <div class="product-filtersbox" id="filtersbox">
            <li>
                <a href="/neatest/html/shop/allproducts.php" class="item-link">All items</a>
            </li>
            <li>
