...
if(isset($_POST['add_to_bag'])) {
    ...
    $select_bag = "SELECT * FROM bag WHERE pname =$product_title";
    if $select_bag  > 0{
        echo 'product has already been added to bag';
    }else {
        $insert_product = "INSERT INTO bag (title, price, image, quantity) VALUES ('$product_title', '$product_price', '$product_image', '$product_quantity')";
