...
if(isset($_POST['add_to_bag'])) {
    ...
    // note I need to create titles for items, if they have the same title of nothing it won't work
    $select_bag = mysqli_query($conn, "SELECT * FROM bag WHERE title = '$product_title'");
...
<body>
    <div class="container">
        ...
        <div class="bg">
            ...
            <?php
                $select_rows = mysqli_query($conn, "SELECT * FROM bag WHERE title = $product_title") or die('query failed');
                $row_count = mysqli_num_rows($select_rows);
            ?>
            <div class="baglink">
                <a href="/neatest/html/bag.html"class="blue-link">bag <span><?php echo $row_count; ?></span> </a>
            </div>
            <div class="divide">
                <div class="product">
