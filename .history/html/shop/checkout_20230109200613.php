                        ...
                        <form action="/neatest/php/main php/check_out.php" method="post">
                            <?php
                              ...
                              if (isset($_COOKIE['email'])) {
                                echo '<input type="text" class="short-form" placeholder="Name" name="email" value="' . htmlspecialchars($_COOKIE['email']) . '">';
                              } else {
                                echo '<input type="text" class="short-form" placeholder="g" name="email">';
                              }
                            ?>
