<?php
    ...
    $images = array("hoodie.jpeg", "tshirt.jpeg", "trousers.jpeg");

    foreach ($images as $image) {
    $image_data = file_get_contents("/neatest/html/shop/images/" . $image);
    $encoded_images[$image] = base64_encode($image_data);
    }

    $sql = "INSERT INTO product_stock (image) VALUES ('$encoded_image')";
            ...
            <div class="divide">
                ...
                <div class="pdescription">
                    ...
                    <form action="" method="post">
                        ...
                        <input type="submit" value="Add to bag" id="bagbtn" class="bagbtn" name="add_to_bag">
