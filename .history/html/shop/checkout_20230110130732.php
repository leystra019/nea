                        ...
                        <form action="/neatest/php/main php/check_out.php" method="post">
                            <?php
                              ...
                              if (isset($_COOKIE['phone'])) {
                                echo '<input type="phone" class="short-form" placeholder="Phone Number" required title="This field is required" name="phone" value="' . htmlspecialchars($_COOKIE['phone']) . '">';
                              } else {
                                echo '<input type="phone" class="short-form" placeholder="Phone Number" required title="This field is required" name="phone">';
                              }
