          ...
          <div class = "checkoutcontainer">
              ...
              <div class="left-content">
                <form action=" " id="checkout-form" method="post">
                  ...
                  <input type="text" class="short-form" placeholder="Postcode" required title="This field is required" name="postcode" maxlength="6" pattern="[A-Za-z]{1,2}[0-9Rr][0-9A-Za-z]? [0-9][ABD-HJLNP-UW-Zabd-hjlnp-uw-z]{2}
