                    ...
                    <div class="left-content">
                      <form action=" " id="checkout-form" method="post">
                        ...
                        <?php
                          ...
                          echo '<input type="name" class="short-form" placeholder="Name" name="name" required title="This field is required" value="' . htmlspecialchars($row['name']) . '">';
                          echo '<input type="email" class="short-form" placeholder="Email" required title="This field is required" name="email" value="' . htmlspecialchars($row['email']) . '">';
                          echo '<input type="text" class="short-form" placeholder="Phone Number" required title="This field is required" name="phone" maxlength="14" value="' . htmlspecialchars($row['phone']) . '">';
                          echo '<input type="text" class="short-form" placeholder="Residence" required title="This field is required" name="residence" value="' . htmlspecialchars($row['residence']) . '">';
                          echo '<input type="text" class="long-form" placeholder="Billing Adress" required title="This field is required" name="billingad" value="' . htmlspecialchars($row['billingad']) . '">';
                          echo '<input type="text" class="long-form" placeholder="Shipping Adress" required title="This field is required" name="shippingad" value="' . htmlspecialchars($row['shippingad']) . '">';
                          echo '<input type="text" class="short-form" placeholder="City" name="city"  required title="This field is required" value="' . htmlspecialchars($row['city']) . '">';
                          echo '<input type="text" class="short-form" placeholder="Postcode" name="postcode"  required title="This field is required" value="' . htmlspecialchars($row['postcode']) . '">';
