...
<head>
    ...
    <script src="/neatest/hjs/checkout.js"></script>
</head>
<body>
<body>
    <div class="container">
                ...
                <div class = "checkoutcontainer">
                    ...
                    <div class="left-content">
                        <form action="/neatest/php/main php/check_out.php" method="post">
                            <?php
                              ...
                              if (isset($_COOKIE['phone'])) {
                                echo '<input type="text" class="short-form" placeholder="Phone Number" required title="This field is required" name="phone" onblur="validatePhoneNumber(this.value)" value="' . htmlspecialchars($_COOKIE['phone']) . '">';
                              } else {
                                echo '<input type="text" class="short-form" placeholder="Phone Number" required title="This field is required" onblur="validatePhoneNumber(this.value)" name="phone">';
                              }
                              ...
                              if (isset($_COOKIE['postcode'])) {
                                echo '<input type="postcode" class="short-form" placeholder="Postcode" name="postcode" required title="This field is required" value="' . htmlspecialchars($_COOKIE['postcode']) . '">';
                              } else {
                                echo '<input type="postcode" class="short-form" placeholder="postcode" required title="This field is required" name="postcode">';
                              }
                        ...
                        <div class="saveinfotxt">
                          <?php echo '<label for="saveinfo" onclick = "saveinfo()" class="saveinfotxt">Save this info for future purchases? </label><input type="checkbox" id="saveinfo">'; ?>
                        </div>
